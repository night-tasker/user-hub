...
namespace NightTasker.UserHub.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240124191705_RenameTables")]
            ...
            modelBuilder.Entity("NightTasker.UserHub.Core.Domain.Entities.OrganizationUser", b =>
                {
                    ...
                    b.HasOne("NightTasker.UserHub.Core.Domain.Entities.UserInfo", "UserInfo")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_organization_users_user_info_user_info_id");
            ...
            modelBuilder.Entity("NightTasker.UserHub.Core.Domain.Entities.UserImage", b =>
                {
                    b.HasOne("NightTasker.UserHub.Core.Domain.Entities.UserInfo", "UserInfo")
                        ...
                        .HasConstraintName("fk_user_images_user_info_user_info_id");
